...
replace (
	...
	k8s.io/component-helpers => /tmp/ca-update-vendor.ou1l/kubernetes/staging/src/k8s.io/component-helpers
...
replace github.com/linode/linodego => github.com/linode/linodego v0.24.1
